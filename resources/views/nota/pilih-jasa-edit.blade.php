...
<div class="page-content">
  ...
  <div class="row">
    ...
    <form action="{{url('post-nota-jasa-edit')}}" method="POST" enctype="multipart/form-data" class="form-horizontal" style="overflow: hidden;">
      {{ csrf_field()}} 
    ...
    <div class="form-group">
     ...
     <div class="col-sm-6">
      <input type="number" min="0" step="0.01" class="form-control" name="fr" id="banyaknya" value="0" onblur="checkNum($(this))">
    </div>
  </div>

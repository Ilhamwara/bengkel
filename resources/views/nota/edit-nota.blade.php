            ...
            <div class="table-responsive">
              <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                 ...
                 <td colspan="2" class="text-center"><div class="input-group"><span class="input-group-addon">Rp</span><input type="text" name="jumlah_part" class="form-control" id="jumlah" value="{{($est_part->sum('jumlah'))}}" disabled style="text-align: right;"></div></td>
               </tr>
               <tr>
                 <td class="text-center" colspan="3"><b>Discount</b></td>
                 <td colspan="2" class="text-center"><div class="input-group"><span class="input-group-addon">Rp</span><input type="text" name="disc_part" class="form-control" id="disc" style="text-align: right;" value="{{$nota->disc_part}}"></div></td>
               </tr>
               <tr>
                 <td class="text-center" colspan="3"><b>Total</b></td>
                 <td colspan="2" class="text-center"><div class="input-group"><span class="input-group-addon">Rp</span><input type="text" name="total_part" class="form-control" id="sum1" readonly style="text-align: right;"></div></td>
               </tr>
             </table>
           </div>
     ...
     <div class="portlet light bordered">
       ...
       <div class="portlet-body">
        <table class="table table-striped table-bordered table-hover">
          ...
          <tr>
           <td class="text-center" colspan="3"><b>Jumlah</b></td>
           <td colspan="2" class="text-center"><div class="input-group"><span class="input-group-addon">Rp</span><input type="text" name="jumlah_jasa" class="form-control" id="jumlah2" value="{{$est_jasa->sum('jumlah')}}" disabled style="text-align: right;"></div></td>
         </tr>
         <tr>
           <td class="text-center" colspan="3"><b>Discount</b></td>
           <td colspan="2" class="text-center"><div class="input-group"><span class="input-group-addon">Rp</span><input type="text" name="disc_jasa" class="form-control" id="disc2" style="text-align: right;"  value="{{$nota->disc_jasa}}"></div></td>
         </tr>
         <tr>
           <td class="text-center" colspan="3"><b>Total</b></td>
           <td colspan="2" class="text-center"><div class="input-group"><span class="input-group-addon">Rp</span><input type="text" name="total_jasa" class="form-control" id ="sum" readonly style="text-align: right;"></div></td>
         </tr>
       </table>
...
<div class="row">
  <div class="col-sm-10 col-sm-offset-1">
   <div class="form-group">
    ...
    <div class="col-sm-8">
      <div class="input-group"><span class="input-group-addon">Rp</span><input type="text" class="form-control" name="dp" id="dp" value="{{$nota->dp}}"></div>
    </div>
  </div>

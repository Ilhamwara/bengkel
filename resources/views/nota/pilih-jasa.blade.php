...
<div class="page-content">
  ...
  <div class="row">
    ...
    <form action="{{url('post-pilih-jas')}}" method="POST" enctype="multipart/form-data" class="form-horizontal" style="overflow: hidden;">
      {{ csrf_field()}} 
      <input type="hidden" name="wo" value="{{$wo}}">
      <input type="hidden" name="idest" value="{{$idnot}}">
      <input type="hidden" name="tipe" value="notjasa">           
    ...
    <div class="form-group">
     ...
     <div class="col-sm-6">
      <input type="number" step="0.01" class="form-control" name="fr" id="banyaknya" value="0" onblur="checkNum($(this))">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <span class="input-group-addon">Rp</span>
      <input type="text" class="form-control" name="harga_perfr" id="data_harga" readonly style="text-align: right;"></div>
    </div>
  </div>
  {{-- <div class="form-group">
    ...
    <div class="col-sm-6"> <div class="input-group">
    <span class="input-group-addon">Rp</span>
      <input type="text" class="form-control" name="total_harga_jasa" id="sum" value="0" readonly style="text-align: right;"></div>
    </div>
  </div> --}}
</div>
<div class="form-group">

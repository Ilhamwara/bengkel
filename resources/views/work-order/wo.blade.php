							...
							<tr>
								...
								<td class="text-center">
									<ul class="action">
										...
										<li><a href="{{url('work-order/'.$ord->id)}}" class="btn btn-warning"  data-toggle="tooltip" title="Detail" style="padding: 6px 12px;"><i class="fa fa-eye"></i></a></li>
										...
										<li><a href="{{url('buat-estimasi-biaya/'.$ord->id)}}" class="btn btn-success"  data-toggle="tooltip" title="Buat Estimasi Biaya" style="padding: 6px 12px;"><i class="fa fa-calculator"></i></a></li></a></li>

...
<div class="page-content">
    ...
    <!-- END PAGE BAR -->
    <!-- BEGIN PAGE TITLE-->
    <h3 class="page-title"><b>List User</b></h3>
    <br>
    <div class="row">
        <div class="col-md-12">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <ul class="action">
                                        <li><a href="{{url('edit/user/'.$data->id)}}" class="btn btn-warning"  data-toggle="tooltip" title="Edit" style="padding: 6px 12px;"><i class="fa fa-pencil"></i></a></li>
                                        <li><a href="{{url('hapus/user/'.$data->id)}}" class="btn btn-danger"  data-toggle="tooltip" title="Hapus" style="padding: 6px 12px;"><i class="fa fa-trash-o"></i></a></li>
                                    </ul>
                                </td>
                            </tr>
                            @empty
